...
# KBurdette,2.25.2020, Finished off ToDo labled sections
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def remove_data_from_list(task, list_of_rows):
        # TODO: Add Code Here!
        for eachrow in list_of_rows:
            if task == eachrow['Task']:
                list_of_rows.remove(eachrow)
                return list_of_rows, 'Success'
        return list_of_rows, "The following task was not in your ToDo list: " + task

    @staticmethod
    def write_data_to_file(file_name, list_of_rows):
        # TODO: Add Code Here!
        writeobjFile = open(strFileName,"w")
        for eachrow in list_of_rows:
            writeobjFile.write(eachrow["Task"] + "," + eachrow["Priority"] + "\n")
        writeobjFile.close()
        return list_of_rows, 'Success'
...
class IO:
    ...
    def input_new_task_and_priority():
        task = input("What task do you wish to add? ")
        priority = input("How important is it? ")
        return task, priority

    @staticmethod
    def input_task_to_remove():
        task = input("Congratulations! What task are you crossing off? ")
        return task
